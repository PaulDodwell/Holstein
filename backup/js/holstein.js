...
var holsteinModule = angular.module('holsteinModule',['ngRoute','ngDialog','ngAnimate','ui.bootstrap','threeViewer.services','threeViewer.controllers','threeViewer.directives','hmTouchEvents']);
...
holsteinModule.controller('traitCtrl',['$scope','$rootScope','$routeParams','DataObj','PreLoader',function ($scope, $rootScope, $routeParams, dataObj, preLoader) {
	...
	//alert(JSON.stringify($scope.imgList));
